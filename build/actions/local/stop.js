...
(function() {
  module.exports = {
    ...
    action: function(params, options, done) {
      var Promise, ResinLocalDockerUtils, chalk, config, forms, ref, selectContainerFromDevice;
      Promise = require('bluebird');
      chalk = require('chalk');
      ref = require('resin-sync'), forms = ref.forms, config = ref.config, ResinLocalDockerUtils = ref.ResinLocalDockerUtils;
      selectContainerFromDevice = require('./common').selectContainerFromDevice;
      return Promise["try"](function() {
        ...
        return function(deviceIp) {
          ...
          _this.appName = (ref1 = options['app-name']) != null ? ref1 : (ref2 = ymlConfig['local_resinos']) != null ? ref2['app-name'] : void 0;
